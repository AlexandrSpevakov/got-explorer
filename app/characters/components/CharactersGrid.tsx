    ...
    <section
      className={
        searchValue.length >= 1 && filteredCharacters.length < 1
          ...
          : 'characters-grid mx-auto mt-10 grid justify-center gap-y-6 sm:mt-8 sm:gap-y-8 sm:px-0 md:mt-10 md:gap-y-10 md:gap-x-5 lg:mt-12 lg:gap-x-6 lg:gap-y-12 xl:mt-16 xl:gap-x-8 xl:gap-y-14 2xl:mt-24 2xl:gap-y-16 2xl:gap-x-10'
      }
    >
