...
export default function Card({ title, family }: CardProps) {
  ...
  return (
    <section className="mx-auto grid w-full grid-cols-card items-center justify-items-center gap-y-4 rounded-md bg-black/40 py-4 px-6 text-center text-base xs:gap-y-6 xs:py-6 xs:px-8 xs:text-xl sm:w-8.5/10 sm:p-8 sm:text-xl md:w-4/6 md:p-10 lg:gap-y-8 lg:p-12 lg:text-2xl xl:gap-y-10 xl:p-14 xl:text-3xl 2xl:py-16 2xl:text-4xl">
