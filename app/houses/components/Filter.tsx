  ...
  return (
    <section ref={sortRef} className="relative pr-16">
      ...
      <ul
        className={
          isOpen
            ? 'absolute top-8 left-5 w-40 rounded bg-neutral-800 py-1.5 shadow-lg duration-200 sm:left-5 sm:w-44 md:top-10 md:left-6 md:w-48 md:py-2 lg:top-12 lg:left-7 lg:w-52 xl:left-9 xl:w-56 2xl:left-11 2xl:top-14 2xl:w-72'
            : 'invisible absolute top-0 left-5 w-40 rounded bg-neutral-800 py-1.5 opacity-0 shadow-lg duration-200 sm:left-5 sm:w-44 md:left-6 md:w-48 md:py-2 lg:left-7 lg:w-52 xl:left-9 xl:w-56 2xl:left-11 2xl:top-14 2xl:w-72'
        }
        aria-hidden={!isOpen}
      >
