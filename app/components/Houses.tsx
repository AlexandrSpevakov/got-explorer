  ...
  return (
    <article id="houses">
      <section className="mx-auto w-11/12">
        <h2 className="pt-28 text-center font-cardo text-5.5xl md:pt-24 md:text-7xl xl:text-7.5xl 2xl:pt-32 2xl:text-8.5xl">
        ...
        <section className="mt-6 2xl:mt-10">
          <Image
            src={housesImg}
            alt="map"
            className="float-right ml-3 mb-1 w-4/12 rounded-md md:ml-5 md:mb-3 2xl:mb-10 2xl:w-3/12"
          />
      ...
      >
        ...
        />
        <h3 className="absolute top-1/4 right-1/2 w-5/6 translate-x-1/2 text-center font-cardo text-5xl opacity-100 duration-500 group-hover:text-orange-600 md:w-4/6 md:text-6xl xl:text-7xl 2xl:text-8xl">
